...
/*Thay ??i thông tin info c?a usersm xóa c? và làm l?i cái m?i picture, userpicture*/
...
/*T?o hóa ??n, t? ??ng c?p nh?t danh sách còn trong cart trong OrderProduct c?a user*/
...
/*T?o user, t? ??ng t?o picture and role of users*/
...
/*T?o create product, kh?i t?o product n?u không t?n t?i Id and t?o picture, size, color by list array*/
...
/*Th?ng kê doanh thu theo kho?n th?i gian*/
...
/*Th?ng kê không ph?i doanh thu theo kho?n th?i gian*/
...
/*Th?ng kê theo s?n ph?m theo kho?n th?i gian*/
...
/*Th?ng kê theo khách hàng theo kho?n th?i gian*/
