    ...
    <?php foreach ($listOrder as $key => $value) { ?> {
        "data": {
            ...
            <?php 
				...
				$promotion = isset($promotionm[0]->Discount ) ? $promotionm[0]->Discount : 0 ; ?> "Discount": "<?php echo ($sumprice*$promotion/100); ?>",
...
<script type="text/javascript" src="{!! url('/js/ManageOrder/confirm.js') !!}"></script>