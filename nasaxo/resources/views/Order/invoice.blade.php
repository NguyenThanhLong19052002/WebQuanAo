...
@section('link')
@parent
<link rel="stylesheet" type="text/css" href="{!! url('/css/Order/invoice.css') !!}">
@stop
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="time">
                ...
                <span class="fa fa-bicycle"> Giao hàng tiêu chuẩn dự kiến trước ngày
                    <?php $date = date('d-m-Y'); $dateNext = new DateTime($date); $dateNext->modify('+7 day'); echo $dateNext->format('d-m-Y'); ?></span>
            </div>
        </div>
        <div class="col-md-6">
            <form class="address-invoice" action="{!! url('cart/order') !!}" method="post">
                ...
                <?php if(isset($user)){
					...
					?>
                <div class=content>
                    <b><?php echo isset($deliveryplace[0]->ReceiveName) ?  $deliveryplace[0]->ReceiveName :""; ?></b>
                    <br>
                    <p>
                        <?php echo isset($deliveryplace[0]->DeliveryPlaces) ?  $deliveryplace[0]->DeliveryPlaces :""; ?>
                        <br>
            ...
            <div class="DonHang row">
                ...
                <div class="col-md-12 content">
                    ...
                    <div class="col-md-12 product">
                        ...
                        <span class="col-md-6 col-md-push-2"><?php echo isset($value->Count)? $value->Count: ""; ?> *
                            <?php echo $pricefinal ?> VNĐ</span>
                    </div>
                    <?php }
						} ?>
                ...
                <div class="col-md-12 TongTien">
                    ...
                    <span class="col-md-6 col-md-push-2">
                        <h3><?php echo $total-$DiscountPrice; ?> VNĐ</h3>
                    </span>
                </div>
...
@section('script')
@parent
<script type="text/javascript" src="{!! url('/js/Order/invoice.js') !!}"></script>
@stop