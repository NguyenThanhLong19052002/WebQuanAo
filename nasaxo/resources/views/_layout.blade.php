...
<head>
    ...
    <link rel="stylesheet" href="{!! url('/images/default.jpg') !!}">
    <!-- font fa. -->
    ...
    <!-- css my cústom -->
    <link rel="stylesheet" type="text/css" href="{!! url('/css/Home/Home.css') !!}">
    @show
...
<body>
    ...
    <form id="frmPage" style="display:'none';" action="{!! url('/') !!}" method="GET" enctype='multipart/form-data'>
        <input id="pageList-frm" type="hidden" name="pageList"
            value="<?php echo isset($param['pageList']) ? $param['pageList'] : 0 ?>">
        <input id="numberRecord-frm" type="hidden" name="numberRecord"
            value="<?php echo isset($param['numberRecord']) ? $param['numberRecord'] : 12 ?>">
        <input id="productCategory-frm" type="hidden" name="productCategory"
            value="<?php if (isset($param['productCategory'])) echo $param['productCategory'] ?>">
        <input id="nameProduct-frm" type="hidden" name="nameProduct"
            value="<?php if (isset($param['nameProduct'])) echo $param['nameProduct'] ?>">
        <input id="bestSeller-frm" type="hidden" name="bestSeller" value="<?php if (isset($param['bestSeller'])) {
                                                                                echo $param['bestSeller'];
                                                                            } else {
                                                                                echo '0';
                                                                            } ?>">
    </form>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul id="dropdownMenu" class="dropdown-menu">
                            ...
                            ?>
                            <li class="category-home" data-category='<?php echo $value['id']; ?>'>
                    ...
                    <li id="accountHome">
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown"><img
                                src="{!! url('//images') !!}/<?php echo $savedAccount['image']; ?>"
                                class="user-image-home" alt="User Image"><b class="caret"></b></a>
    ...
    <!-- easing -->
    <script type="text/javascript" src="{!! url('/js/Home/jquery.easing.1.3.js') !!}"></script>
