...
<!-- my custom -->
<link rel="stylesheet" type="text/css" href="{!! url('/css/ManageColor/index.css') !!}">
<!-- Modal -->
                        ...
                        <div class="col-sm-10">
                            <div class="input-group col-sm-12">
                                ...
                                <textarea class="form-control txtDescription" id="inputDescriotion"
                                    placeholder="Nhập mô tả màu sắc"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
...
<!-- end container -->
<!-- script custom js -->
<script type="text/javascript" src="{!! url('/js/ManageColor/index.js') !!}"></script>
<!-- data table -->