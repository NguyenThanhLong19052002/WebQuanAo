    ...
    <table class="Table-Pagin table table-hover table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th class="table-Sort" data-sort="BasePurchare" style="width: 16%;"
                    title="Số tiền ít nhất để đạt khuyến mãi">Yêu cầu</th>
...
<script type="text/javascript" src="{!! url('/js/ManagePromotion/_search.js') !!}"></script>