...
<!-- my custom -->
<link rel="stylesheet" type="text/css" href="{!! url('/css/ManagePromotion/index.css') !!}">
...
<body>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="">
                        ...
                        <div class="form-group" title="Số tiền ít nhất để đạt khuyến mãi">
                            ...
                            <div class="col-xs-9">
                                <div class="input-group col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="promotionBasePureChase"
                                        name="promotionBasePureChase">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <div class="input-group col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="promotionDiscount"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group col-sm-12">
                                    <span class="input-group-addon"><i class="fa fa-comment"
                                            aria-hidden="true"></i></span>
            ...
            <div class="col-xs-12 header-content">
                <div class="col-md-4">
                    <button id="btnAdd" class="btn btn-info" data-toggle="modal"
                        data-target="#PromotionModal">+</button>
    ...
    <!-- end container -->
    <!-- script custom js -->
    <script type="text/javascript" src="{!! url('/js/ManagePromotion/index.js') !!}"></script>