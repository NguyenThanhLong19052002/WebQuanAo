...
@section('link')
@parent
<link rel="stylesheet" type="text/css" href="{!! url('/css/Cart/Cart.css') !!}">
@stop
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3>Giỏ hàng <span>(<span
                        id="countProduct"><?php echo isset($listCartProduct) ?  count($listCartProduct) : 0?></span> sản
                    phẩm)</span></h3>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 product_image">
                    <img class="img-responsive thumbnail"
                        src="{!! url('/images') !!}/<?php echo $productItem->Pictures()->get()[0]->Url ?>">
                </div>
                <div class="col-md-4 name">
                    ...
                    <div class="color">
                        ...
                        <span class="radio-inline">
                            ...
                            <input id="rdColor_<?php echo $productItem->id; ?>_<?php echo $valueColor->id; ?>"
                                class="radio-infomation" type="radio" name="rdColor_<?php echo $productItem->id; ?>"
                                <?php if($valueColor->id==$valueProductOrder->ID_Color){ echo "checked";} ?>
                    ...
                    <div class="Size">
                        ...
                        <span class="radio-inline">
                            ...
                            <input id="rdSize_<?php echo $productItem->id; ?>_<?php echo $valueSize->id; ?>"
                                class="radio-infomation" type="radio" name="rdSize_<?php echo $productItem->id; ?>"
                                <?php if($valueSize->id == $valueProductOrder->ID_Size){ echo "checked";} ?>
                ...
                <div class="col-md-1 delete">
                    <button class="btn btn-default btnCart btn-delete "
                        data-delete="<?php echo $valueProductOrder->id; ?>">
...
<div class="container">
    <div class="total-prices">
        <div class="row">
            <h3 class="finalTotalPrice pull-right">
                <?php if(isset($sumPrice) && $sumPrice > 0){ echo $sumPrice;}else{echo '0';} ?> VNĐ</h3>
            <h3 class="pull-right" style="margin-right: 20px;">Tổng tiền:</h3>
        </div>
    </div>
    <div class="row">
        <form id="submitCart" enctype="multipart/form-data" action="{!! url('/cart/order') !!}" method="POST"
            name="frmBuy">
            {{csrf_field()}}
            <div class="button-Order">
                <input id="countCart" type="text" class="hidden"
                    value="<?php echo isset($listCartProduct) ?  count($listCartProduct) : 0?>" name="">
...
@section('script')
@parent
<script type="text/javascript" src="{!! url('/js/Cart/index.js') !!}"></script>
@stop