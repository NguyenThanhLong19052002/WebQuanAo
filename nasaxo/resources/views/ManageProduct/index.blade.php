<!-- my custom -->
<link rel="stylesheet" type="text/css" href="{!! url('/css/ManageProduct/index.css') !!}">
<!-- Modal -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <div class="input-group col-sm-12">
                                ...
                                <input type="text" class="form-control" id="discountProduct" name="discountProduct"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div id="inputPictureGroup" class="inputPictureGroup col-sm-12">
                                ...
                                <input type="file" name="inputPicture" class="inputPicture" multiple
                                    style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group col-sm-12">
                                ...
                                <textarea class="form-control txtDescription" id="inputDescriotion"
...
<!-- end container -->
<!-- script custom js -->
<script type="text/javascript" src="{!! url('/js/ManageProduct/index.js') !!}"></script>