...
@parent
<!-- Swiper css -->
<link rel="stylesheet" type="text/css" href="{!! url('/css/ProductDetail/swiper.min.css') !!}">
<!-- custom file css -->
<link rel="stylesheet" href="{!! url('/css/ProductDetail/index.css') !!}">
@stop
@section('content')
<div class="container">
    <div class="row">
        ...
        <div class="product-detail col-xs-12 ">
            <div class="col-xs-2 col-md-1 listImgPrduct">
                ...
                <img class="img-loader" src="{!! url('/images') !!}/<?php echo  $valuePicture->Url; ?>">
                <?php endforeach ?>
            </div>
            <!-- start product-detail image -->
            <div class="col-md-3 col-xs-5 product-detail-image">
                <img id="product-detailImgItem" class="zoom-img product-detail-imgItem"
                    src="{!! url('/images') !!}/<?php echo isset($listPicture[0]) ? $listPicture[0]->Url : 'default.jpg'; ?>"
                    alt="First slide">
            </div>
            <!-- end image -->
            ...
            <div class="product-detail-infomation col-md-7 col-xs-4">
                ...
                <div class="product-detail-star">
                    ...
                    <img data-product="<?php echo $itemProduct->id; ?>" data-point='<?php echo $iPoint ?>'
                        src="{!! url('/images') !!}/<?php echo $iPoint<=$Point ? 'star-on.png' : 'star-off.png' ?>"
                        alt="<?php echo $iPoint ?>">
                    <?php
					}
				} ?>
                ...
                <div class="field-col">
                    ...
                    <span
                        class="product-detail-price"><?php echo $price->Price - ($price->Price * $price->Discount / 100); ?>
                        VNĐ</span>
			...
			if(count($listSize)>0){?>
                <div class="field-col">
                    ...
                    <span class="radio-inline">
                        ...
                        <input id="rdSize_<?php echo $itemProduct->id; ?>_<?php echo $valueSize->id; ?>"
                            class="radio-infomation" type="radio" name="rdSize_<?php echo $itemProduct->id; ?>"
                            data-size="<?php echo $valueSize->id; ?>">
			...
			if(count($colorProduct)>0){?>
                <div class="field-col">
                    ...
                    <div class="radio-field">
                        <span class="radio-inline">
                            ...
                            <input id="rdColor_<?php echo $itemProduct->id; ?>_<?php echo $valueColor->id; ?>"
                                class="radio-infomation" type="radio" name="rdColor_<?php echo $itemProduct->id; ?>"
                                data-color="<?php echo $valueColor->id; ?>">
                ...
                <?php } ?>
                <!-- end color -->
                <div class="add-cart" data-id='<?php echo $itemProduct->id; ?>'
                    data-name="<?php echo $itemProduct->Name; ?>">
            ...
            <div class="involve-content">
                <div class="swiper-container swiper-container-horizontal swiper-container-free-mode">
					...
					?>
                        ...
                        <div class="swiper-slide" title="<?php echo $valueInvolve->Name; ?>"
                            onclick="detailProduct(<?php echo $valueInvolve->id; ?>)"">
						<?php $img = $valueInvolve->Pictures()->get(); ?>
						<div class=" image-invole"
                            style="background-image: url('{!! url('/images/') !!}/<?php echo isset($img[0]) ? $img[0]->Url : "default.jpg"; ?>');">
                        </div>
                        <span class="title-invole"><?php echo substr($valueInvolve->Name,0,22).' ...' ?></span>
                        <span
                            class="price-invole"><?php echo $priceInvolve->Price - ($priceInvolve->Price * $priceInvolve->Discount / 100); ?>
                            VNĐ</span>
    ...
    <div class="product-detail-comment col-xs-12">
        ...
        <div class="cmt-container">
            <div class="fb-comments" data-href="{!! url(''); !!}/product?id=<?php echo $itemProduct->id; ?>"
...
@parent
<!-- swiper js -->
<script type="text/javascript" src="{!! url('/js/ProductDetail/swiper.min.js') !!}"></script>
<!-- elevatezoom -->
<script type="text/javascript" src="{!! url('/js/ProductDetail/jquery.elevatezoom.js') !!}"></script>
<!-- custom javascript -->
<script type="text/javascript" src="{!! url('/js/ProductDetail/index.js') !!}"></script>
@stop
<?php } ?>