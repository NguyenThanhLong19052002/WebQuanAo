...
<!-- my custom -->
<link rel="stylesheet" type="text/css" href="{!! url('/css/ManageProductCategory/index.css') !!}">
<!-- Modal -->
                        ...
                        <div class="col-xs-9">
                            <div class="input-group col-sm-12">
                                ...
                                <input type="text" class="form-control" id="ProductCategory" name="ProductCategory"
                                    value="Nhóm sản phẩm" placeholder="Nhập thông tin nhóm sản phẩm">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-xs-12 header-content">
            <div class="col-md-4">
                <button id="btnAdd" class="btn btn-info" data-toggle="modal"
                    data-target="#ProductCategoryModal">+</button>
...
<!-- script custom js -->
<script type="text/javascript" src="{!! url('/js/ManageProductCategory/index.js') !!}"></script>