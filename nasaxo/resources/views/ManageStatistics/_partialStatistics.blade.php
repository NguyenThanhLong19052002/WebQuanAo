<div class="row">
    <div class="col-md-12 headerTable" style="margin-top:35px;">
        <img style="width: 20px;height: 20px;cursor: pointer;" id="changeStyle"
            src="{!! url('/images') !!}/Refresh_icon.png" class="pull-left" />
    </div>
    <canvas id="statistic-Chart"></canvas>
</div>

<script type="text/javascript" src="{!! url('/js/Chart.min.js') !!}"></script>
<script type="text/javascript" src="{!! url('/js/ManageHome/mychart.js') !!}"></script>
<script>
//<!--function paint chart-->
styleChart = "bar";
var element = document.getElementById("statistic-Chart");
MyJS_paintStatistics(styleChart, element, <?php echo isset($labels) ? json_encode($labels) :"[]"; ?>,
    <?php echo isset($countOrder) ? json_encode($countOrder) :"[]"; ?>,
    <?php echo isset($totalPrice) ? json_encode($totalPrice) :"[]"; ?>);
