                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="getView" data-view="address/city"><a><i class="fa fa-circle-o"></i>Thành phố</a>
                            </li>
                            <li class="getView" data-view="address/district"><a><i class="fa fa-circle-o"></i>Quận
                                    huyện</a></li>
                            <li class="getView" data-view="address/ward"><a><i class="fa fa-circle-o"></i>Phường xã</a>
                            </li>
                        </ul>
                    </li>
                    <!-- ./ địa chỉ -->
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="getView" data-view="statictis/revenue"><a><i class="fa fa-circle-o"></i>Doanh
                                    thu</a></li>
                            <li class="getView" data-view="statictis/nonrevenue"><a><i class="fa fa-circle-o"></i>Không
                                    phải doanh thu</a></li>
                            <li class="getView" data-view="statictis/bestsell"><a><i class="fa fa-circle-o"></i>Sản
                                    phẩm</a></li>
                            <li class="getView" data-view="statictis/customer"><a><i class="fa fa-circle-o"></i>Khách
                                    hàng mua nhiều</a></li>
                        </ul>
                    </li>
                    <!-- end thống kê -->
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="getView" data-view="order/new"><a><i class="fa fa-circle-o"></i>Đơn đặt hàng chưa
                                    xác nhận</a></li>
                            <li class="getView" data-view="order/confirm"><a><i class="fa fa-circle-o"></i>Đơn đặt hàng
                                    đã xác nhận</a></li>
                        </ul>
                    </li>
                    <!-- end hóa đơn -->
