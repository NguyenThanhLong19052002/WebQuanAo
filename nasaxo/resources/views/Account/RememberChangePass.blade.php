    ...
    <div class="rememver-content">
        <div class="infomation-content">
            ...
            <div class="find-content">
                ...
                <input class="txtInputRemember" type="password" name="txtEmail" id="txtPass"
                    placeholder="Nhập mật khẩu">
                <span class="Remember-email">Nhập lại</span>
                <input class="txtInputRemember" type="password" name="txtEmail" id="txtPassRe"
...
@section('script')
@parent
<script type="text/javascript" src="{!! url('/js/Account/RememberChangePass.js') !!}"></script>
@stop