...
<div class="row">
    <div class="col-xs-12 infomation-account">
        ...
        <h4 id="h4Mesage">Thông báo<span>( <span
                    class='countNotify'><?php echo isset($countNotify)? $countNotify :'0' ?> </span> )</span></h4>
        <!-- start content -->
...
@parent
<!-- my script -->
<script type="text/javascript" src="{!! url('/js/Account/index.js') !!}"></script>
@stop