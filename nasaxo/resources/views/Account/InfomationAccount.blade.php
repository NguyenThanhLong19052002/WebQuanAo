<?php if (isset($user)) { ?>
<link rel="stylesheet" type="text/css" href="{!! url('/css/Account/information.css') !!}">
<form enctype="multipart/form-data" id="upload_form" method="POST" action="" class="row">
    ...
    <div class="imageUser col-xs-2">
        ...
        <img title="Click để thay đổi hình ảnh" class="input-Img" id="imgUser"
            src="{!! url('/images') !!}/<?php echo isset($image[0]) ? $image[0]->Url : "default.jpg"; ?>">
    ...
    <div class="col-xs-10">
        ...
        <div class="group-content">
            ...
            <input id="txtUserName" disabled class="field-input" type="text" name="userName"
        ...
        <div class="group-content">
            ...
            <input class="field-input" disabled type="text" name="txtEmail" id="txtEmail"
        ...
        <div class="group-content">
            ...
            <textarea class="field-input" type="text" name="Description"
                id="txtDescription"><?php echo $user->Description; ?></textarea>
        </div>
        <!-- end description -->
        <div class="group-content">
        ...
        <div id="Password-content" class="password-content" style="display: none;">
            <div class="group-content">
                ...
                <input class="field-input" type="password" name="txtOldPass" id="txtOldPass"
                    placeholder="Nhập mật khẩu củ" value="">
                <i id="checkOldPass" style="display: none;" aria-hidden="true"></i>
            </div>
            <div class="group-content">
                <span class="field-lable">Mật khẩu mới: </span>
                <input class="field-input" type="password" name="txtOldPass" id="txtPass"
                    placeholder="Nhập mật khẩu từ 8 đến 32 ký tự" value="">
                <i id="checkPass" style="display: none;" aria-hidden="true"></i>
            </div>
            <div class="group-content">
                <span class="field-lable">Nhập lại: </span>
                <input class="field-input" type="password" name="txtOldPass" id="txtRePass"
...
<script type="text/javascript" src="{!! url('/js/Account/InfomationAccount.js') !!}"></script>
<?php } ?>
<!-- end content -->
<!-- end container -->
<!-- custom js -->